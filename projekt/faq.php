        ...
        <div class="poli kontent bg-coolors-5">
          ...
          <div class="accordion-item bg-coolors-5">
              <h2 class="accordion-header" id="flush-headingFour">
                <button class="accordion-button collapsed bg-coolors-4" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFour" aria-expanded="false" aria-controls="flush-collapseThree">
